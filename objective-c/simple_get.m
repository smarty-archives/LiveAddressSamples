...
int main(int argc, const char * argv[])
{
    ...
    @autoreleasepool {
        ...
        NSURLRequest *request = [NSURLRequest requestWithURL:[NSURL URLWithString:@"https://api.qualifiedaddress.com/street-address?street=1109+9th&city=phoenix&state=arizona&zipcode=85007&auth-id=<URL-ENCODED-AUTH-ID>&auth-token=<URL-ENCODED-AUTH-TOKEN>"]];
